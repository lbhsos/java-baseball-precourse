...
public class Message {
    ...
    public static final String INVALID_LENGTH_INPUT_MESSAGE = "1-9 사이의 서로 다른 임의의 수로 이루어진 '3자리의 수'를 입력하여주세요.";
    ...
    public static final String DIFFERENT_VALUE_REQUIRED_MESSAGE = "1-9 사이의 서로 '다른' 임의의 수로 이루어진 3자리의 수를 입력하여주세요.";
    public static final String INVALID_RANGE_INPUT_MESSAGE = "'1-9 사이'의 서로 다른 임의의 수로 이루어진 3자리의 수를 입력하여주세요.";

    public static void printInputRequired() {
        System.out.print(BASEBALL_INPUT_REQUIRED_MESSAGE);
    }

    public static void printAskingContinueGame() {
